...
if 'Permission denied' in shadow_file:
    print('[' + Fore.RED + 'Access Denied' + Fore.RESET + '] ' + Fore.WHITE + 'No ' + Fore.RED + 'READ ACCESS ' + Fore.WHITE + 'to Shadow File' + Fore.RESET)
if 'root' in shadow_file:
    print('[' + Fore.RED + 'Access Granted' + Fore.RESET + '] ' + Fore.WHITE + 'We have ' + Fore.RED + 'READ ACCESS ' + Fore.WHITE + 'to Shadow File' + Fore.RESET)
