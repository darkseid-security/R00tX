...
nopasswd = subprocess.getoutput('sudo -u root -n true | su root')
...
if 'a password is required' in nopasswd or 'Authentication failure' in nopasswd:
...
if 'may not run sudo' in perm:
    print('[' + Fore.CYAN + 'Getting Permissions' + Fore.RESET + '] ' + Fore.WHITE + "Can't list permissions due to user not part of SUDOERS Group" + Fore.RESET)
...
if "Can't connect to local MySQL" in mysql:
    print('[' + Fore.CYAN + 'MySQL Login Failed' + Fore.RESET + '] ' + Fore.WHITE + "MySQL can't connect to local MySQL Server" + Fore.RESET)  
if 'not found' in mysql:
    print('[' + Fore.CYAN + 'MySQL Login Failed' + Fore.RESET + '] ' + Fore.WHITE + 'MySQL not installed' + Fore.RESET)
if 'mysql>' in mysql:
...
get_programs = input('[' + Fore.CYAN + 'Question' + Fore.RESET + '] ' + Fore.WHITE + 'Did you want to list installed software packages ' + Fore.CYAN + ' Y/N ' + Fore.RESET)
if get_programs.upper() == "Y":
    installed_programs = subprocess.getoutput("dpkg -l")
    print(Fore.WHITE + installed_programs + Fore.RESET)    
